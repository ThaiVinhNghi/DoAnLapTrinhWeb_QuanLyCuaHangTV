                    ...
                    <tbody>
                        <?php if ($result && $result->num_rows > 0): ?>
                            <?php while ($row = $result->fetch_assoc()): ?>
                                ...
                                <tr>
                                    <td class="ps-3 fw-bold text-danger text-start">#TG<?php echo $row['ID']; ?></td>
                                    <td class="text-start">
                                    ...
                                    <td>
                                        <span class="badge bg-info text-dark"><?php echo (int)$row['SoThangTraGop']; ?></span>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif ($row['TrangThai'] == 'Đã chuyển hóa đơn'): ?>
                                            <span class="badge bg-primary">Đã chuyển HĐ</span>
                                    ...
                                    <td>
                                        <a href="tra_gop_chi_tiet.php?id=<?php echo $row['ID']; ?>" class="btn btn-outline-info btn-sm" title="Xem chi tiết">
