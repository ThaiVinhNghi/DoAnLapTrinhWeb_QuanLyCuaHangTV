        ...
        <div class="row g-0">
            ...
            <div class="col-md-7">
                <div class="card-body p-5">
                    ...
                    <h3 class="text-danger fw-bold mb-4"><?php echo number_format($sp['DonGia'], 0, ',', '.'); ?> VNĐ</h3>
                    ...
                    <form action="them_gio_hang.php" method="POST" class="d-flex align-items-center">
                        ...
                        <input type="number" name="so_luong" value="1" min="1" max="<?php echo $sp['SoLuong']; ?>" class="form-control text-center me-3" style="width: 80px;">
