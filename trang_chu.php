<?php
session_start();
require_once 'connect.php'; // File này nằm ở ngoài cùng (thư mục gốc)
?>
...
<head>
    ...
    <style>
        ...
        .product-img {
            height: 200px;
            object-fit: contain; /* Đổi sang contain để không bị mất góc tivi */
            width: 100%;
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="d-flex align-items-center">
                <a href="gio_hang.php" class="btn btn-warning me-2 position-relative fw-bold">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                // Đường dẫn ảnh từ trang chủ vào thư mục uploads
